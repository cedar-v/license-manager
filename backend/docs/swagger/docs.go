...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/cu/invoices": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "申请日期筛选，格式YYYY-MM-DD",
                        "name": "apply_date",
                        "in": "query"
                    }
                ],
        ...
        "/api/leads/{id}/status": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "状态: pending/contacted/converted/invalid",
                        "name": "status",
                        "in": "query",
                        "required": true
                    }
        ...
        "/api/v1/authorization-codes/{id}/download": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "models.LeadResponse": {
            ...
            "properties": {
                ...
                "follow_up_date": {
                    "description": "跟进日期（RFC3339，如 2026-02-05T10:00:00Z）",
                    "type": "string"
                },
                "follow_up_record": {
                    "description": "跟进记录",
