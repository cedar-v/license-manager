...
(UUID(), '试用版', 'trial', 0, '免费', '当月25日到期', '免费体验全部功能', '["全部功能", "1个许可"]', 1, 1, NOW(), NOW()),
(UUID(), '基础版', 'basic', 300, '300元/许可', '永久有效', '小型企业最佳选择', '["基础功能", "批量许可购买"]', 1, 2, NOW(), NOW()),
(UUID(), '专业版', 'professional', 2000, '2000元/许可', '永久有效', '企业级完整解决方案', '["全部功能", "技术支持", "数据分析"]', 1, 3, NOW(), NOW()),
(UUID(), '企业定制版', 'custom', 0, '定制报价', '按需定制', '按需定制解决方案', '["按需定制", "专属服务"]', 1, 4, NOW(), NOW());
