...
-->
<template>
  <Layout app-name="License Manager" :nav-items="navigationItems" :breadcrumb-items="breadcrumbs" page-title="系统用户"
...
const navigationItems = ref<NavItem[]>([
  ...
  { id: "users", label: "系统用户", href: "/users", icon: "users", active: true }
]);
