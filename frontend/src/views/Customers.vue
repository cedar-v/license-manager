...
-->
<template>
  <Layout app-name="License Manager" :nav-items="navigationItems" :breadcrumb-items="breadcrumbs" page-title="客户管理"
...
const navigationItems = ref<NavItem[]>([
  ...
  { id: "customers", label: "客户管理", href: "/customers", icon: "customers", active: true },
